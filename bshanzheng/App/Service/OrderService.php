...
class OrderService
{
    ...
    {
        $templateId = 'xQWefNfWVXUmrbEDhz0pm2cS18790Oxb4R5jOC8wl1w';
    ...
    {
        $templateId = 'rM-Xm2WnF-VaajqS4MlTZtLwYJ82xhhPhwrLXB5H890';
...
var_dump($upstairsUser);
    ...
    {
        $templateId = 'ThIAP21tIHbIi1vXEzWn8qLitmL59A8pcHkgG9Kj1_Y';
    ...
    {
        $templateId = 'xQWefNfWVXUmrbEDhz0pm8uegPnIseeWpPn6bcclG1Q';
    ...
    {
        $templateId = 'ADW8IhPFexFXWpkFOmJCr7JfWl-Yc87zLLL6sPG8Tr4';
    ...
    {
        $templateId = '2aSqgojmjO1iAealkMHP8m98EFozCRgyo8nQxDqMoZI';
