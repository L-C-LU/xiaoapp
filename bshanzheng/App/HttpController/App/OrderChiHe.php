...
class OrderChiHe extends BaseController
{
    ...
    public $rules_add = [
        ...
        'room_num|宿舍号' => 'requireIf:need_upstairs,1|int|max:10',
...
var_dump('efffffffffffffff');
        return $this->apiSuccess(['order_id' => $this->order['order_id'],
            'wechat_params' => $params,
                //'template_ids' => ['ThIAP21tIHbIi1vXEzWn8qLitmL59A8pcHkgG9Kj1_Y','xQWefNfWVXUmrbEDhz0pm2cS18790Oxb4R5jOC8wl1w','rM-Xm2WnF-VaajqS4MlTZtLwYJ82xhhPhwrLXB5H890']
