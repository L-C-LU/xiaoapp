...
return [
    ...
    'MYSQL' => [
        //数据库配置
        'host'                 => '172.17.0.9',//数据库连接ip
        'user'                 => 'shanzheng',//数据库用户名
        'password'             => 'shanzheng3329',//数据库密码
        'database'             => 'yqshuai_data',//数据库
        'port'                 => '50101',//端口
        'timeout'              => '30',//超时时间
        'connect_timeout'      => '50',//连接超时时间
    ...
    'UPLOAD' =>[
        ...
        "engine" => [
            ...
            "aliyun" => [
                ...
                "domain" => "http://yqshuai.oss-cn-shanghai.aliyuncs.com/"
            ],
            "qcloud" => [
                "bucket" => "",
                "region" => "",
    ...
    /*############### 小程序设置 ###################*/
    'MINI_PROGRAM' => [
        'appid' => 'wx50dedcf65f53d8b1',
        'secret' => '35d164e70cb87279722b1367ffec66f9'
    ],
    'TENCENT_LBS' =>[
    ...
    'APP_WECHAT' =>[//223323
        ...
        'notify_url' => 'http://api.yqshuai.top:9508/Publics/PayResult/wechat',
